    ...
    <section id="how-it-works" className="flex flex-col w-full bg-[#0D0D0D] py-16 px-6 md:py-[100px] md:px-[120px] gap-12 md:gap-[64px]">
      ...
      <div className="flex flex-col md:flex-row w-full gap-[2px]">
        <StepCard
          number="01"
          title={"COLLECT\nSIGNALS"}
          description="JOB POSTINGS, EMPLOYER SURVEYS, AND SECTOR DATA PULLED CONTINUOUSLY."
        />
        <StepCard
          number="02"
          title={"ANALYZE\nTHE GAP"}
          description="AI MATCHES DEMAND AGAINST EXISTING CURRICULA AND FLAGS MISMATCHES."
          bgColor="#111111"
          borderColor="#FFD600"
          borderWidth={1}
        />
        <StepCard
          number="03"
          title={"RECOMMEND\n& ACT"}
          description="INSTITUTES GET COURSE UPDATES. GOVERNMENT GETS DISTRICT TRAINING PLANS."
        />
      </div>
    </section>
  );
