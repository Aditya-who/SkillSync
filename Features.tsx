  ...
  return (
    ...
    >
      <SectionHeader
        ...
        subtitle="BUILT FOR STUDENTS, INSTITUTES, AND POLICYMAKERS ALIKE."
      />
      ...
      <div className="flex flex-col md:flex-row w-full gap-[2px]">
        <FeatureCard
          iconColor="#FFD600"
          title={"REAL-TIME\nSKILL SIGNALS"}
          description="LIVE JOB POSTING DATA PARSED WITH NLP TO SURFACE ACTUAL, CURRENT DEMAND. NOT LAST YEAR'S SURVEY."
          tag="[LIVE]"
          tagColor="#FFD600"
          borderColor="#FFD600"
        />
        <FeatureCard
          iconColor="#FF6B35"
          title={"CURRICULUM\nGAP MAPPING"}
          description="COURSES MAPPED DIRECTLY TO IN-DEMAND SKILLS. OUTDATED MODULES FLAGGED AUTOMATICALLY."
          tag="[CORE]"
          tagColor="#FF6B35"
          bgColor="#0F0F0F"
          borderColor="#FF6B35"
        ...
        <FeatureCard
          ...
          description="GEOGRAPHIC BREAKDOWN OF SKILL GAPS TO GUIDE TRAINING CAPACITY AND POLICY."
          tag="[MAP]"
          tagColor="#888888"
          borderColor="#555555"
        />
